...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(incomeDataAdapter.getName() + " " +incomeDataAdapter.getCompanyName() + " " +incomeDataAdapter.getCountryName()
        + " " +incomeDataAdapter.getPhoneNumber());
        ...
        public String getCountryName() {
           ...
           String value = "";
            for (Map.Entry<String, String> pair : countries.entrySet()){
                if (pair.getKey().equals(data.getCountryCode())) value = pair.getValue();
            }
            return value;
        }
    }
